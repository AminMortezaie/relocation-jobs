...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "Search the public preview, sign in to track applications and manage your job search across Germany, Netherlands, UK, and Portugal.",
    ...
    <div className="min-h-screen">
      <div className="mx-auto max-w-site px-4 pb-8 pt-5 sm:px-5">
        ...
        <main className="mx-auto mt-12 max-w-2xl">
          <h1 className="text-fluid-hero text-text">How It Works</h1>
          ...
          <section className="mt-10 space-y-6">
            <Card className="px-5 py-6">
              <h2 className="text-lg font-semibold text-text">1. Browse the public preview</h2>
            ...
            <Card className="px-5 py-6">
              <h2 className="text-lg font-semibold text-text">2. Sign in to unlock tracking</h2>
              <p className="mt-2 text-sm leading-relaxed text-muted">
            ...
            <Card className="px-5 py-6">
              <h2 className="text-lg font-semibold text-text">3. Tailor your CV per job</h2>
              <p className="mt-2 text-sm leading-relaxed text-muted">
            ...
            <Card className="px-5 py-6">
              <h2 className="text-lg font-semibold text-text">4. Stay current</h2>
              <p className="mt-2 text-sm leading-relaxed text-muted">
