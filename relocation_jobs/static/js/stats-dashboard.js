...
export function buildAdminStatsHtml(stats, { escapeHtml, formatActivityBadge }) {
    ...
    <div class="stats-dashboard">
      <section class="stats-group">
        <div class="stats-row">
          ...
          ${statCard(stats.companies_with_jobs, "Co. with open roles", { escapeHtml })}
          ${statCard(stats.latest_fetch_new_jobs ?? 0, "New today", { escapeHtml })}
      ...
      <section class="stats-group">
        <div class="stats-row">
          ...
          ${statCard(stats.positions_not_for_me ?? 0, "Not for me", { escapeHtml })}
